...
export async function renderServerSide(jsx, clientScripts, clientComponentList) {
...
export function renderServerSideInWorker(pageModulePath, clientScripts, clientComponentList) {
  // TODO: Promise.withResolvers
  const workerData = { pageModulePath, clientScripts, clientComponentList };
  return new Promise((resolve, reject) => {
    const worker = new Worker("./lib/rsc-worker.js", { workerData });
